    ...
    return (
        ...
        >
            ...
            <ListGroupItem 
                ...
                id="wd-neu-link"
            >
                <img src="/NEU.jpg" width="103px" alt="Northeastern University" />
            </ListGroupItem>
            <br />

            {/* Account Link - White background, white text and icon */}
            ...
            {/* Dashboard Link - White background, red text and icon */}
            ...
            {/* Calendar Link - Black background, white text, red icon */}
            <ListGroupItem className="border-0 bg-black text-center">
            ...
            {/* Inbox Link - Black background, white text, red icon */}
            <ListGroupItem className="border-0 bg-black text-center">
            ...
            {/* Labs Link - Black background, white text, red icon */}
            <ListGroupItem className="border-0 bg-black text-center">
