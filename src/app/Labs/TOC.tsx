...
export default function TOC() {
    ...
    return (
        <Nav variant="pills">
            ...
            <NavItem>
                <NavLink href="/Labs/Lab4" as={Link} className={`nav-link
                ${pathname.endsWith("Lab4") ? "active" : ""}`}>
                    Lab 4
                </NavLink>
            </NavItem>
            <NavItem>
                <NavLink href="/Labs/Lab5" as={Link} className={`nav-link
                ${pathname.endsWith("Lab5") ? "active" : ""}`}>
                    Lab 5
                </NavLink>
            </NavItem>
            <NavItem>
                <NavLink href="https://github.com/Addy-9595/kambaz-next-js-cs5016-fall2025" id="wd-github">
                    My GitHub
                </NavLink>
            </NavItem>
        </Nav>
